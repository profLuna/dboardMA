...
### PM2.5
```{r mapPM25, fig.align="center", fig.cap="Map of Census block groups with the highest concentrations of one or more priority populations AND highest PM2.5 concentrations."}
...
### DPM
```{r mapDPM, fig.align="center", fig.cap="Map of Census block groups with the highest concentrations of one or more priority populations AND highest Diesel Particullate Matter (DPM) concentrations."}
# create color palette
...
### Traffic
```{r mapPTRAF, fig.align="center", fig.cap="Map of Census block groups with the highest concentrations of one or more priority populations AND highest Traffic Proximity and Volume (PTRAF) values - Annual Avg Daily Traffic/Distance(km) to High Traffic Corridor."}
# create color palette
...
sketch1 = htmltools::withTags(table(
  ...
  thead(
    tr(
      ...
      th(colspan = 2, 'Avg PM2.5'),
      th(colspan = 2, 'Avg Diesel Particulate Matter'),
      th(colspan = 2, 'Avg Traffic Burden')
    ),
    tr(
...
These tables show the average air pollution concentration values (micrograms per cubic meter of air) or average traffic burden scores (Proximity to High Traffic Corridors) by jurisdiction, along with the rank. A rank indicates the percentage of jurisdictions that are below that value. For example, Boston has a PM~2.5~ concentration value of 6.7 micrograms per cubic meter, and a PM~2.5~ rank of 93.4. The latter means that 93.4% of all other municipalities in the state have a lower average PM~2.5~ concentration. 
