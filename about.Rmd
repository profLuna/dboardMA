...
This online application is built with the  [flexdashboard](http://rstudio.github.io/flexdashboard/index.html) package for the [R programming language](https://www.r-project.org/). Charts, tables, and maps use [Highcharts](http://www.highcharts.com/),  [ggplot2](http://ggplot2.org/), [DataTables](https://datatables.net/), and [Leaflet.js](http://leafletjs.com/), all accessed through their corresponding R packages.  
