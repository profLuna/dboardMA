...
leaflet() %>% 
  ...
  addLegend(colors = "red",
            labels = "No Bus Access + Hi Priority Pops",
            position = "bottomleft") %>%
...
leaflet() %>% 
  ...
  addPolygons(data = ma_blkgrps_sf_Hwy, 
              ...
              highlight = highlightOptions(
                ...
                fillOpacity = 0.7,
                bringToFront = TRUE)) %>% 
  addLegend(title = "Highest Avg Headways<br>(minutes)", 
            pal = palHwy,
...
leaflet() %>% 
  ...
  addPolygons(data = ma_blkgrps_sf_Walk, 
              ...
              highlight = highlightOptions(
                ...
                fillOpacity = 0.7,
                bringToFront = TRUE)) %>% 
  addLegend(title = "Least Walkable Scores", 
            pal = palWalk,
...
leaflet() %>% 
  ...
  addPolygons(data = ma_blkgrps_sf_Tcost, 
              ...
              highlight = highlightOptions(
                ...
                fillOpacity = 0.7,
                bringToFront = TRUE)) %>% 
  addLegend(title = "Highest Transport Cost Burdens<br>(% Household Income)", 
            pal = palTcost,
